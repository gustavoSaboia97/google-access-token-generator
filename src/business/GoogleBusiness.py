from src.business.validation import validate_to_refresh_token
...
class GoogleBusiness:
    ...
    def generate_refresh_token_and_access_token(self, app_data: dict):
    ...
    def generate_access_token(self, app_data: dict):
